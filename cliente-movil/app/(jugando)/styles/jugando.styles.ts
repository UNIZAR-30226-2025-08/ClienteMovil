...
export const estilos = StyleSheet.create({
  ...
  contenedorEmpiezanVotacionesAlguacil: {
    position: "absolute",
    width: "80%",
    top: "25%",
    justifyContent: "center",
  ...
  textoEmpiezanVotacionesAlguacil: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.08,
    textAlign: "center",
  },

  contenedorEmpiezanVotacionesSospechososSerLobo1: {
    position: "absolute",
    width: "70%",
    top: "25%",
    justifyContent: "center",
  ...
  textoEmpiezanVotacionesSospechososSerLobo1: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.08,
    textAlign: "center",
  },

  contenedorEmpiezanVotacionesSospechososSerLobo2: {
    position: "absolute",
    width: "80%",
    top: "45%",
    justifyContent: "center",
  ...
  textoEmpiezanVotacionesSospechososSerLobo2: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.08,
    textAlign: "center",
  },
  contenedorAnimacionCazador: {
    position: "absolute",
    width: "80%",
    top: "30%",
    justifyContent: "center",
  ...
  textoAnimacionCazador: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.1,
    textAlign: "center",
  },
  contenedorAnimacionBrujaCura: {
    position: "absolute",
    width: "80%",
    top: "35%",
    justifyContent: "center",
  ...
  textoAnimacionBrujaCura: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.1,
    textAlign: "center",
  },
  contenedorAnimacionBrujaVeneno: {
    position: "absolute",
    width: "80%",
    top: "35%",
    justifyContent: "center",
  ...
  textoAnimacionBrujaVeneno: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.09,
    textAlign: "center",
  },
  contenedorAnimacionDormir: {
    position: "absolute",
    width: "80%",
    top: "40%",
    justifyContent: "center",
  ...
  textoAnimacionDormir: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.1,
    textAlign: "center",
  },
  contenedorAnimacionDevora: {
    position: "absolute",
    width: "80%",
    top: "25%",
    justifyContent: "center",
  ...
  textoAnimacionHombresLoboDormir: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.08,
    textAlign: "center",
  },
  contenedorAnimacionBrujaDespierta: {
    position: "absolute",
    width: "80%",
    top: "25%",
    justifyContent: "center",
  ...
  textoAnimacionBrujaDespierta: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.1,
    textAlign: "center",
  },
  contenedorAnimacionBrujaDuerme: {
    position: "absolute",
    width: "80%",
    top: "40%",
    justifyContent: "center",
  ...
  textoAnimacionBrujaDuerme: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.1,
    textAlign: "center",
  },
  contenedorAnimacionVidenteDuerme: {
    position: "absolute",
    width: "80%",
    top: "35%",
    justifyContent: "center",
  ...
  textoAnimacionVidenteDuerme: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.1,
    textAlign: "center",
  },
  contenedorAnimacionVidenteDespierta: {
    position: "absolute",
    width: "80%",
    top: "20%",
    justifyContent: "center",
  ...
  textoAnimacionVidenteDespierta: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.085,
    textAlign: "center",
  },
  contenedorAnimacionNocheSupervivientes: {
    position: "absolute",
    width: "80%",
    top: "30%",
    justifyContent: "center",
  ...
  textoAnimacionNocheSupervivientes: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.85,
    textAlign: "center",
  },
  contenedorAnimacionJugadorAlguacil: {
    position: "absolute",
    width: "70%",
    top: "50%",
    justifyContent: "center",
  ...
  textoAnimacionJugadorAlguacil: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.1,
    textAlign: "center",
  },
  contenedorAnimacionVotacionesConcluidas: {
    position: "absolute",
    width: "80%",
    top: "30%",
    justifyContent: "center",
  ...
  textoAnimacionVotacionesConcluidas: {
    ...textoBlancoCorben,
    fontSize: ancho * 0.1,
    textAlign: "center",
  },
  contenedorAnimacionElegidoPueblo: {
    position: "absolute",
    width: "80%",
    top: "40%",
    justifyContent: "center",
